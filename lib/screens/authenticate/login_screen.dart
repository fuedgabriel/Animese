import 'package:animese/screens/authenticate/create_login.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final TextEditingController _textFieldControllerSenha = TextEditingController();
        ...
        body: ListView(
          children: <Widget>[
            Transform.translate(
              ...
              child: const Image(height: 250,image: AssetImage('assets/images/logo_name.png')),
            ),
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      child: Text(showText, style: const TextStyle(color: Colors.brown),),
                    ),
                  ],
                )
            ),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if(_textFieldControllerEmail.text == "" || _textFieldControllerSenha.text == ""){
                    setState(() {
                      colorLogin = Colors.red;
                      textLogin = "Preencha todos os campos";
                    });
                  }else if(_textFieldControllerEmail.text != "" && _textFieldControllerSenha.text != ""){
                    setState(() {
                      colorLogin = Colors.transparent;
                      textLogin = "";
                    });
                    AuthenticateRequest.login(_textFieldControllerEmail.text, _textFieldControllerSenha.text).then((value)  => {
                      if(value == false){
                        setState(() {
                          colorLogin = Colors.red;
                          textLogin = "E-mail ou senha incorretos";
                        })
                      }else{
                    ...
                    // print(prefs.getString('telefone'));
            ...
            ElevatedButton(
                ...
                child: const Text('Esqueceu a senha?', style: TextStyle(color: Colors.white, fontSize: 18),),
            ),
            ...
            TextButton(
                ...
                child: const Text('Entrar como convidado', style: TextStyle(color: Colors.white70, fontSize: 15),),
            )
